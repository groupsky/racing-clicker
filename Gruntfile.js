...
module.exports = function (grunt) {
    ...
    test: {
      constants: {
        env: {
          ...
          googleApiKey: 'AIzaSyA2hdWwd0-GSEMzuvMidCrx6Ge7Kjona7U',
  ...
  grunt.initConfig({
    ...
    preloadSpreadsheet: {
      'v0.7.0': 'https://docs.google.com/spreadsheets/d/1xjwCSOHF8OFJDYqdW71V0TFI321Bof-7J4-zaJg_skY/pubhtml',
    },
    mxmlc: {
      options: {
